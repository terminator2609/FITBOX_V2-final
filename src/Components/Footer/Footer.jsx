            ...
            <footer>
                ...
                <section>
                    ...
                    <article>
                        ...
                        <ul>
                            <li>
                                <Link>Общи условия</Link>
                            </li>
                            <li>
                                <Link>Политика за защита на лични данни</Link>
                            </li>
                            <li>
                                <Link>Политика за бисквитки</Link>
                            </li>
                            <li>
                                <Link>Доставка</Link>
                            </li>
                            <li>
                                <Link to="/cancel">Канселиране</Link>
                            </li>
                            <li>
                                <Link>Рекламация</Link>
                            </li>
                        </ul>
                    </article>
                    ...
                    <article>
                        <h1>Контакти</h1>
                        <ul>
                            <li>Варна, България</li>
                            <li>office@myfitbox.bg</li>
                            <li>+359 (0) 876728018</li>
                        </ul>
                    </article>
                ...
                <section>
                    <article>
                        ...
                        <p>© Green Global 2022 Ltd. | all rights reserved</p>
                    </article>

                    <article>

                        <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="2.69em" height="1em"
                            preserveAspectRatio="xMidYMid meet" viewBox="0 0 256 83">
                            <defs>
                                <linearGradient id="svgIDa" x1="45.974%" x2="54.877%" y1="-2.006%" y2="100%">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="1.29em" height="1em"
